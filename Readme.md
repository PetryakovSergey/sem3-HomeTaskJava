На языках Java реализовать абстрактный класс "Животное" со следующими полями:
1.Рост животного
2.Вес животного
...
Так же реализовать следующие абстрактные классы, реализующие интерфейс Животное:
